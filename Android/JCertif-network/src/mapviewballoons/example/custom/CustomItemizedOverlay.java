...
import com.jcertif.reseaujcertif.interfaces.ihm.ProfilMemebre;
...
public class CustomItemizedOverlay<Item extends OverlayItem> extends BalloonItemizedOverlay<CustomOverlayItem> {
	...
	protected boolean onBalloonTap(int index, CustomOverlayItem item) {
		JCertifManager.getInstance().setSelectedUser(JCertifManager.getInstance().getListUsers().get(index));
		Intent intent = new Intent(c, ProfilMemebre.class);
